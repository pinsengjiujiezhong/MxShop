...
class GoodsCategory(models.Model):
    ...
    code = models.CharField(max_length=30, default='', verbose_name='类别名code', help_text='类别名code')
...
class Goods(models.Model):
    ...
    goods_brief = models.CharField(max_length=500, null=True, blank=True, default='', verbose_name='商品简短描述')
